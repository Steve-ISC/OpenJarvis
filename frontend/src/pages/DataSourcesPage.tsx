...
const MESSAGING_CHANNELS: MessagingChannelConfig[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'bot_token', label: 'Bot Token', placeholder: '123456:ABC-DEF1234...', type: 'password', required: true },
      { key: 'chat_id', label: 'Chat ID', placeholder: 'Your numeric chat ID', type: 'text', required: true },
    ],
    ...
    howToUse: (cfg: Record<string, unknown>) => 'Open Telegram and send a message to your bot. The agent will respond automatically.',
  },
];
